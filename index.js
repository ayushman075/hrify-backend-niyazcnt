...
app.use(cors({
  origin:['http://localhost:5174','http://192.168.1.5:5555','https://iridescent-parfait-9b7d28.netlify.app','*','http://localhost:5173','https://hrify-frontend-plum.vercel.app','https://hrify-frontend-crvwhg7b2-ayushman075s-projects.vercel.app','https://hrify-niyazcnt.vercel.app', 'https://hrify-bims.vercel.app'],
  credentials:true,
...
import { documentVaultRouter } from "./routes/employeeDocument.routes.js";
...
app.use("/api/v1/employeeDocument",documentVaultRouter)
...
app.get('/', (req, res) => {
  res.send('Welcome to HRIFY BIMS, on this line you are taking to HRIFY server !!');
});
