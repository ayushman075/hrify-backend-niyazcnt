...
const EmployeeSchema = new Schema({
  ...
  // --- Employment Lifecycle Type ---
  employmentType: {
    type: String,
    enum: ['Trainee', 'Probation', 'FullTime', 'Contractual', 'Suspended', 'Resigned', 'Terminated', 'Promoted'],
    required: true,
    default: 'FullTime'
  },

  // Department and Division removed - inferred via Post relation
  post: {
